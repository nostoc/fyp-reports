...
\begin{enumerate}
    ...
    new development proposals, policy decisions, or community-related plans. Citizens should be able to view active polls in the DApp feed and vote anonymously using a valid one-time ticket or nullifier. Each citizen should be allowed to vote only once per poll, selecting either accept or reject.
\end{enumerate}
