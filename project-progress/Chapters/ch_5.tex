...
Although the current prototype supports both text moderation and image safety
moderation, the moderation system is still limited to a controlled experimental
environment. The image moderation component focuses mainly on detecting unsafe
visual content. It does not fully verify whether an image is geographically
authentic, whether it was captured at the reported location, or whether it was
generated or manipulated using generative AI tools.
