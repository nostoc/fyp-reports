...
\noindent {Screenshots:} Fig.~\ref{fig:m3-1-rejected}.
...
\noindent {Screenshots:} Fig.~\ref{fig:m3-2-review}, Fig.~\ref{fig:m3-2-closed}.
...
\noindent {Screenshots:} Fig.~\ref{fig:m3-3-reopened}.
...
\noindent {Screenshots:} Fig.~\ref{fig:m3-5-validation}.
...
\subsubsection{Scenario 8 - Double vote}
 {Role:} Citizen \\
...
\subsubsection{Scenario M4.1 --- Emergency report submission (happy path).}
 {Role:} Citizen. \\
 {Preconditions:} Citizen logged in; citizen is not under an emergency-channel penalty.
...
\end{enumerate}
\noindent {Expected result:} The report is created on the emergency path with status \texttt{Open} immediately (validation skipped).

\noindent {Screenshots:} Fig.~\ref{fig:m4-1-consent}, Fig.~\ref{fig:m4-1-open}.

\subsubsection{Scenario M4.2 --- Authority resolve emergency.}
 {Role:} Authority worker. \\
 {Preconditions:} An emergency report in \texttt{Open} (from M4.1).
...
\end{enumerate}
\noindent {Expected result:} Status becomes \texttt{Resolved}.

\noindent {Screenshots:} Fig.~\ref{fig:m4-2-resolved}.

\subsubsection{Scenario M4.3 --- Reclassify false emergency.}
 {Role:} Authority worker. \\
 {Preconditions:} A separate emergency report that should be treated as non-urgent abuse of the channel.

\begin{enumerate}
    \item On the emergency report detail, choose Downgrade / Reclassify (false emergency) and confirm.
\end{enumerate}
\noindent {Expected result:} Status becomes \texttt{Reclassified}; the reporting citizen receives a 30-day lock on the emergency channel.

\noindent {Screenshots:} Fig.~\ref{fig:m4-3-reclassified}.

\subsubsection{Scenario M4.4 --- Emergency penalty enforcement (negative path).}
 {Role:} Penalized citizen. \\
 {Preconditions:} Citizen from M4.3 is within the 30-day emergency lock.

\begin{enumerate}
    \item Attempt to submit another emergency report.
    \item Submit a standard (non-emergency) report with the same account.
\end{enumerate}
\noindent {Expected result:} The second emergency submission is blocked; the standard report is still accepted through the normal pipeline.

\noindent {Screenshots:} Fig.~\ref{fig:m4-4-penalty}.

\subsubsection{Scenario M4.5 --- Emergency without consent (negative path).}
 {Role:} Citizen. \\
 {Preconditions:} Citizen on \texttt{/report}.
...
\end{enumerate}
\noindent {Expected result:} Emergency submission does not proceed without consent.

\noindent {Screenshots:} Fig.~\ref{fig:m4-5-cancel-consent}.

\subsection{Opinion Polling}

\subsubsection{Scenario M5.1 --- Authority creates a poll.}
 {Role:} Authority worker. \\
 {Preconditions:} Authority wallet connected.
...
\end{enumerate}
\noindent {Expected result:} Poll is visible to citizens and listed under the Authority Polls tab.

\noindent {Screenshots:} Fig.~\ref{fig:m5-1-create}, Fig.~\ref{fig:m5-1-list}.

\subsubsection{Scenario M5.2 --- Citizens vote and authority finalizes.}
 {Role:} Citizens, then authority.
 {Preconditions:} Active poll from M5.1 within its deadline.
...
\end{enumerate}
\noindent {Expected result:} Votes are recorded via the relayer; finalized poll no longer accepts new votes and shows a completed state.
\noindent {Screenshots:} Fig.~\ref{fig:m5-2-vote}, Fig.~\ref{fig:m5-2-finalized}.

\subsubsection{Scenario M5.3 --- Poll access and double-vote controls (negative path).}
 {Role:} Citizen. \\
 {Preconditions:} Active poll; citizen already voted once.
...
\end{enumerate}
\noindent {Expected result:} Citizens cannot create official polls; double vote is rejected (nullifier reuse).

\noindent {Screenshots:} Fig.~\ref{fig:m5-3-denied}.

\subsection{Super Admin Governance}

\subsubsection{Scenario M6.1 --- Multisig proposal and majority approval (happy path).}
 {Role:} Super Admins. \\
 {Preconditions:} At least two Super Admin wallets; useful first action is setting a short voting-window duration for later M2/M3 scenarios.
...
\end{enumerate}
\noindent {Expected result:} The change applies only after majority approval; the dashboard reflects the new config or roster.

\noindent {Screenshots:} Fig.~\ref{fig:m6-1-propose}, Fig.~\ref{fig:m6-1-executed}.

\subsubsection{Scenario M6.2 --- Unilateral change and unauthorized access (negative path).}
...
\end{enumerate}
\noindent {Expected result:} Unilateral proposals do not execute; non--Super Admin users are denied the Super Admin dashboard.
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.5\textwidth]{Images/Appendix/me2e/register.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.5\textwidth]{Images/Appendix/me2e/register-success.png}
%    % \fbox{\parbox{0.85\textwidth}{\centering\vspace{3.5cm}[Screenshot M1.1-a: Citizen login]\vspace{3.5cm}}}
%     \caption{Successfull registration of a citizen via government identity simulator}
%     \label{fig:me2e-register-success}
% \end{figure}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.5\textwidth]{Images/Appendix/me2e/login-screen.png}
%     %\fbox{\parbox{0.85\textwidth}{\centering\vspace{3.5cm}[Screenshot M1.1-a: Citizen login]\vspace{3.5cm}}}
%     \caption{Citizen login to the DApp}
%     \label{fig:me2e-login}
% \end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Images/Appendix/me2e/post-progress-update.png}
    %\fbox{\parbox{0.85\textwidth}{\centering\vspace{3.5cm}[Screenshot M1.3: Invalid credentials error]\vspace{3.5cm}}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Images/Appendix/me2e/markasresolved.png}
    %\fbox{\parbox{0.85\textwidth}{\centering\vspace{3.5cm}[Screenshot M1.3: Invalid credentials error]\vspace{3.5cm}}}
