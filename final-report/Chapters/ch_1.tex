...
Digital citizen reporting system is one of many use cases of e-governance. FixMyStreet is one such platform \cite{mysociety2026fixmystreet}. It enables citizens to report issues for different issue categories. Sanitation, Traffic and Public Safety are some examples. Studies show that that FixMyStreet improves governance administrative efficiency, civic participation and  transparency.\cite{oliveira2020smartcities}.
...
A blockchain based police complaint management system that utilize RSA based system has proposed by Pratheeba\cite{pratheeba_blockchain_police_complaint} contains a modular architecture. It includes security, blockchain, web interface and a hybrid cloud storage. This system ensure immutability of complaint records by cryptographic hash linking. Additionally it utilizes RSA based encryption to restrict the access only to authorized personnel. In addition to that, Pratheeba used \ac{NLP} techniques to automatically categorize complaints in the system based on their priorities. 
