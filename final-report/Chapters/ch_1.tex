...
Furthermore, Rui et el \cite{lin2023prirpt} proposed a practical blockchain-based privacy preserving reporting system with rewards. This platform protects reporter privacy by using  Keyed-Verification Anonymous Credential and Structure-Preserving Signatures on Equivalence Classes, instead of \ac{ZKP}. They also implemented a reward mechansim to encourage citizen participation. 
