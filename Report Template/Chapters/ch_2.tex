...
Must be well organized to systematically provide essential information regarding the project \cite{George1993,Michel1993,Peter1990}.
...
or use to the reader. Appendices are also used to support the qualifications of the author, and to increase the credibility of the publication \cite{Xtreport}.
...
\begin{itemize}
   ...
   \item List down all bibliography items.
   \item Each bibliography must be referred to in the text at appropriate places.
   \item refer bibliography by using number. \\
   \texttt{At present 457 out of best 500 super computers use operating systems of Linux family [2]. }
\end{itemize}
...
Chapters can be devied into sections (eg. for chapter 1 sections 1.1, 1.2, 1.3 ..). Sections can be divided into subsections (eg. 1.1.1, 1.1.2, 1.1.3, ..). Subsections are also can be divided into sub-subsections but do not use numbering \cite{batteryuniversity}.
...
When necessary cite equations as for example Eq.(\ref{e:barwq}) and Eq.(\ref{e:ymxc}).
